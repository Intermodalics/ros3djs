...
var CloseCloud = /*@__PURE__*/(function (superclass) {
  function CloseCloud(options) {
    superclass.call(this);
  ...
  if ( superclass ) CloseCloud.__proto__ = superclass;
  CloseCloud.prototype = Object.create( superclass && superclass.prototype );
  CloseCloud.prototype.constructor = CloseCloud;
  CloseCloud.prototype.clone = function clone (object, recursive) {
    if (object === undefined) {
      object = new CloseCloud(this.options);
    }

    THREE$1.Object3D.prototype.clone.call(this, object, recursive);
   ...
   * Callback called when video metadata is ready
   */
  CloseCloud.prototype.metaLoaded = function metaLoaded () {
    this.metaLoaded = true;
    this.initStreamer();
  };
  /**
   * Callback called when video metadata is ready
   */
  CloseCloud.prototype.initStreamer = function initStreamer () {
    if (this.metaLoaded) {
      this.dctexture = new THREE$1.Texture(this.video);
      this.dcgeometry = new THREE$1.Geometry();
      ...
      this.dcmaterial = new THREE$1.ShaderMaterial({
        uniforms: {
          map: {
            type: 't',
      ...
      this.dcmaterial.color = new THREE$1.Color(0xffffff);
      this.mesh = new THREE$1.PointCloud(this.dcgeometry, this.dcmaterial);
   ...
   * Start video playback
   */
  CloseCloud.prototype.startStream = function startStream () {
    if (!this.isMjpeg) {
      this.video.play();
    }
  };
   ...
   * Stop video playback
   */
  CloseCloud.prototype.stopStream = function stopStream () {
    if (!this.isMjpeg) {
      this.video.pause();
    }
    this.video.src = ''; // forcefully silence the video streaming url.
